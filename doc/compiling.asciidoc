...
cd "C:\CGAL-3.7\"
cmake -G"MinGW Makefiles" -DBOOST_ROOT="C:\boost_1_46_1\" -DBOOST_LIBRARYDIR="boost_1_46_1\\bin.v2\\libs\\thread\\build\\gcc-mingw-4.5.2\\debug\\threading-multi" .
make
-------------------------------
