...
win32 {
	INCLUDEPATH += "..\\CGAL-4.0\\include"
	INCLUDEPATH += "..\\CGAL-4.0\\auxiliary\\gmp\\include"
	INCLUDEPATH += "..\\dxflib-2.2.0.0-1.src"
	INCLUDEPATH += "..\\boost_1_49_0"
	LIBS += -L"..\\boost_1_49_0\\bin.v2\\libs\\thread\\build\\gcc-mingw-4.6.2\\release\\threading-multi"
	LIBS += -llibboost_thread-mgw46-mt-1_49
	LIBS += -L"..\\CGAL-4.0\\lib" -lCGAL -lCGAL_Core
	LIBS += -L"..\\CGAL-4.0\\auxiliary\\gmp\\lib" -lmpfr-4 -lgmp-10
